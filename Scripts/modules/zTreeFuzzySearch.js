 ...
 * Date: 2018-04-14
 * 
 * Remarks: 为适用layui，源码由周庆东略作调整，源码解释权归原作者所有
 */
(function (global, factory, layui) {
    ...
    {
        global.zTreeFuzzySearch = factory;

        layui.define(['zTreeCore', 'zTreeExcheck', 'zTreeExhide'], function (exports) {
            exports('zTreeFuzzySearch', factory);
        });
    }
    else {
        global.zTreeFuzzySearch = factory;
     ...
     * @returns
     */
    function (zTreeId, searchField, isHighLight, isExpand) {
